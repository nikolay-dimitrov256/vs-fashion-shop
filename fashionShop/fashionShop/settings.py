...
MIDDLEWARE = [
    ...
    'fashionShop.middleware.custom_locale.CustomLocaleMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'fashionShop.common.context_processors.search_form',
            ],
        },
    },
]
...
SPEEDY_USERNAME = config('SPEEDY_USERNAME')
SPEEDY_PASSWORD = config('SPEEDY_PASSWORD')
ECONT_USERNAME = config('ECONT_USERNAME')
ECONT_PASSWORD = config('ECONT_PASSWORD')
